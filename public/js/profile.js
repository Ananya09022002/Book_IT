...
const loadUserData = ({ coins }) => {
  ...
  <span style="color:#001D6E; font-size:20px;">${coins}</span>
</div>
<div class="option-item">
  <button class="default-btn"><a href="/logout">Logout</a></button>
</div>
<div class="option-item">
<a href="http://localhost:8000/profile"><button class="default-btn"><i class='bx bxs-user'></i>USER</button></a>
</div>
`;
...
async function viewprofile() {
  ...
  document.getElementById(
    "view"
  ).innerHTML = `<div style="margin-top:8%;margin-left:3%;font-size:25px">
  <b><span>Name:</span></b><span>${data.name}</span><br>
                        <b><span>Email:<span></b>${data.email}</span></span><br>
                        <b><span>Coins Available:<span></b>${data.coins}</span></span><br>
                        </div>
                        `;
